namespace module1
{
    public static class Task5
    {
        ...
        {
            Console.WriteLine(SummOfSatisfyingNumbers(strictUpperBound: 30, firstDivisor: 3, secondDivisor: 5));
        }
        ...
        private static int SummOfSatisfyingNumbers(int strictUpperBound, int firstDivisor, int secondDivisor)
        {
            return ArithmeticProgressionUntilBoundSumm(strictUpperBound, firstDivisor)
                ...
                - 2 * ArithmeticProgressionUntilBoundSumm(strictUpperBound, firstDivisor * secondDivisor);
        }
